                ...
                HStack {
                    ...
                    VStack {
                            ...
                            if message.replyTo != previousMessage?.replyTo {
                                HStack {
                                    ...
                                    if replyMessage != nil {
                                        ...
                                        Text(
                                            (replyMessage!.sender == userInfo?
                                                .userID ?? ""
                                                ? userInfo?.userName.capitalized
                                                : users[replyMessage!.sender]?
                        ...
                        if showImage {
                            HStack {
                                WebImage(  // saves the image in a cache so it doesnt re-pull every time
                                    url: URL(
                                        string: (message.sender == userInfo?
                                            .userID ?? ""
                                            ? userInfo?.userImage
                                            : users[message.sender]?.userImage)
                                            ?? ""
                                    ),
                                    content: { image in
                                        image
                        ...
                        ZStack {
                            ...
                            if calendarTimeIsNotSameByHourPreviousMessage
                                && !showImage
                            {
                                HStack {
                                    VStack {
                        ...
                        .overlay {
                            if nonBubbleMenuMessage != nil
                                && nonBubbleMenuMessage?.messageID ?? ""
                                    == message.messageID
                            {
                                HStack {
                                    Spacer()
                                    ...
                                    .shadow(radius: 8)
                                    .scaleEffect(
                                        nonBubbleMenuMessage == nil ? 0.85 : 1
                                    )
                                    .animation(
                                        .spring(
                                            response: 0.25,
                        ...
                        if !sortedReactions.isEmpty {
                            HStack(spacing: 4) {
                                ForEach(sortedReactions, id: \.key) {
                                    emoji,
                                    users in
                                    HStack(spacing: 4) {
                                        Text(emoji)
                                    ...
                                    .onTapGesture {
                                        ...
                                        if let index = usersForEmoji.firstIndex(
                                            of: userID
                                        ) {
                    ...
                    .padding(.bottom)
                    .background(
                        replyToChatMessage?.sender == userInfo?.userID

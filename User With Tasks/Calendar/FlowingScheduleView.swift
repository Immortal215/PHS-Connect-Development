                                ...
                                ZStack(alignment: .leading) {
                                    if refresher {
                                        ...
                                        if let meeting = draggedMeeting {
                                            ...
                                            let intervalsMoved = Int(
                                                dragOffset.height
                                                    / intervalHeight
                                            )

                                            let formattedTime = Calendar.current
                                                .date(
                                                    byAdding: .minute,
                                            ...
                                            let startOffset =
                                                CGFloat(startMinutes)
                                                * hourHeight * scale / 60
                                            let duration =
                                                CGFloat(durationMinutes)
                                                * hourHeight * scale / 60
    ...
    func calculateColumnAssignments() -> [MeetingColumn] {
        ...
        for meeting in sortedMeetings {
            ...
            columnAssignments.append(
                MeetingColumn(meeting: meeting, column: column)
            )
